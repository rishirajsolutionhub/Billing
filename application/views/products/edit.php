          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="price" name="price" placeholder="Enter Selling Price" value="<?php echo $product_data['price']; ?>" autocomplete="off" />
                </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select_group" id="attributes_value_id" name="attributes_value_id[]" multiple="multiple">
                        <?php foreach ($v['attribute_value'] as $k2 => $v2): ?>
                          <option value="<?php echo $v2['id'] ?>" <?php if($attribute_id) { if(in_array($v2['id'], $attribute_id)) { echo "selected"; } } ?>><?php echo $v2['value']; ?></option>
                        <?php endforeach ?>
                      </select>
                    </div>    
                  <?php endforeach ?>
