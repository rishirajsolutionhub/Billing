                    ...
                    <?php if(isset($order_data['order_item'])): ?>
                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                            <input type="text" name="sku[]" id="sku_<?php echo $x; ?>" class="form-control" onkeyup="getProductDataBySKU(<?php echo $x; ?>)" autocomplete="off" value="<?php echo $val['sku']; ?>">
                            <input type="hidden" name="sku_value[]" id="sku_value_<?php echo $x; ?>" class="form-control" autocomplete="off"  value="<?php echo $val['sku']; ?>">
                          </td>
                          <td>
                            <input type="text" name="product_name[]" id="product_name_<?php echo $x; ?>" class="form-control" disabled autocomplete="off"  value="<?php echo $val['name']; ?>">
                            <input type="hidden" name="product[]" id="product_<?php echo $x; ?>" class="form-control" autocomplete="off"  value="<?php echo $val['product_id']; ?>">
                          </td>
                          ...
                          <td>
                            ...
                            <input type="hidden" name="cost_price_value[]" id="cost_price_value_<?php echo $x; ?>" class="form-control" value="<?php echo $val['cost_price'] ?>" autocomplete="off">
                          </td>
                          <td>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input type="hidden" class="form-control" id="net_profit_value" name="net_profit_value" value="<?php echo $order_data['order']['profit'] ?>" autocomplete="off">
                    </div>
                  </div>
