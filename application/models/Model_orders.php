...
class Model_orders extends CI_Model
{
	...
	public function getOrdersItemData($order_id = null)
	{
		...
		$sql = "SELECT orders_item.*,products.name,products.sku FROM orders_item,products WHERE orders_item.product_id = products.id and order_id = ?";
	...
	public function create()
	{
		...
		$bill_no = 'BILPR-'.strtoupper(substr(md5(uniqid(mt_rand(), true)), 0, 10));
    	$data = array(
    		'bill_no' => $bill_no,
    		...
    		'profit' => $this->input->post('net_profit_value'),
    		'paid_status' => 2,
    		'user_id' => $user_id
    	);
